...
import { cn } from '@/lib/utils'; // Make sure cn is available usually in utils
  ...
  return (
    <div className='min-h-screen bg-neutral-50 pt-24 pb-20 font-sans'>
      <div className='container mx-auto max-w-6xl px-4'>
        <div className='mb-8'>
          <h1 className='text-display-xs md:text-display-sm font-extrabold text-neutral-900'>
            My Orders
          </h1>
        </div>
            ...
            <div className='space-y-4'>
              {isLoading ? (
                ...
                <div className='flex h-64 flex-col items-center justify-center rounded-xl border border-neutral-200 bg-white p-6 text-center'>
                  ...
                  {/* If empty state for specific status is needed, can be customized */}
                </div>
              ) : (
